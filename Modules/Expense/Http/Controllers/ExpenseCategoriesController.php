...
class ExpenseCategoriesController extends Controller
{
    ...
    public function store(Request $request) {
        ...
        toast('Kategori Beban Dibuat!', 'success');
    ...
    public function update(Request $request, ExpenseCategory $expenseCategory) {
        ...
        toast('Kategori Beban Diperbarui!', 'info');
    ...
    public function destroy(ExpenseCategory $expenseCategory) {
        ...
        if ($expenseCategory->expenses()->isNotEmpty()) {
            return back()->withErrors('Tidak bisa menghapus karena terdapat beban dengan kategori ini.');
        }

        $expenseCategory->delete();

        toast('Kategori Beban Dihapus!', 'warning');
