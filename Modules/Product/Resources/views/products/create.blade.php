            ...
            <div class="row">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="barcode_symbology">Sistem Simbologi Barcode <span class="text-danger">*</span></label>
                                        <select class="form-control" name="product_barcode_symbology" id="barcode_symbology" required>
                                            <option value="" selected disabled>Pilih Sistem Simbologi</option>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="product_unit">Unit <i class="bi bi-question-circle-fill text-info" data-toggle="tooltip" data-placement="top" title="Teks ini akan ditempatkan setelah Jumlah Produk."></i> <span class="text-danger">*</span></label>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                <label for="image">Foto Produk <i class="bi bi-question-circle-fill text-info" data-toggle="tooltip" data-placement="top" title="Jumlah File Maksimal: 3, Ukuran File Maksimal: 1MB, Ukuran Gambar: 400x400"></i></label>
